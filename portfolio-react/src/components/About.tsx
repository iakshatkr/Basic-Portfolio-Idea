  ...
  return (
    <section id="about" className="section">
      <div className="container grid gap-10 lg:grid-cols-[0.95fr_1.05fr] lg:items-start">
        <div data-reveal="slide-right" data-tilt className="glass-subcard rounded-[2rem] border border-white/10 bg-white/[0.04] p-6 shadow-[0_30px_80px_rgba(0,0,0,0.16)] backdrop-blur-xl sm:p-8">
        ...
        <div className="grid gap-4">
          {focusAreas.map((area, index) => (
            <article key={area.title} data-reveal="slide-up" data-reveal-delay={index * 0.08} data-tilt className="card p-6 sm:p-8">
